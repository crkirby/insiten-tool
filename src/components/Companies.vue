  ...
  <div class="targets">
    ...
    <div v-if="lastRequested" class="request">
      ...
      <p class="request--message">
        {{ lastRequested.name }} has been added to your
        <router-link class="to-dashboard" to="/dashboard"
...
.target {
  ...
  &__btn {
    ...
    box-shadow: 0rem 0.2rem 0.4rem 0rem #084c61;
